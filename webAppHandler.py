...
from gameApp import HomePage, Play, GameSocket


class SequenceOnline(tornado.web.Application):
    is_closing = False
...
def makeApp():
    ...
    return SequenceOnline(handlers=buildHandlers(), **settings)
